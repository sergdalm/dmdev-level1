...
import com.sergdalm.week8.practice.dmdev.dto.Activity;
...
public class StatisticReportGenerator implements ReportGenerator {
    ...
    private String generateDetailedPart(LogFileDay logFileDay) {
        ...
        Stream<String> stringStream = lectures.entrySet().stream().map(it -> buildReportPartRow(it.getKey(), it.getValue(), allTime.get()));
